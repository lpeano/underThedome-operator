...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	c, err := controller.New("statefulset-controller", mgr, controller.Options{Reconciler: r,MaxConcurrentReconciles:20})
	if err != nil {
		return err
	}

	// Watch for changes to primary resource StatefulSet
	err = c.Watch(&source.Kind{Type: &corev1api.StatefulSet{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &corev1api.StatefulSet{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileStatefulSet) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &corev1api.StatefulSet{}
	...
	if err != nil {
        ...
        reqLogger.Info("StatefulSet event on ", "StatefulSet.Namespace", instance.Namespace, "StatefulSet.Name", instance.Name)
